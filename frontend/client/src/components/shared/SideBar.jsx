...
const SidebarWithHeader = ({children}) => {
    ...
    return (
        <Box minH="100vh" bg={useColorModeValue('gray.100', 'black.900')}>
            <SidebarContent
                onClose={() => onClose}
...
const SidebarContent = ({onClose, ...rest}) => {
    return (
        <Box
            ...
            h="full"
            {...rest}>
            <Flex  flexDirection="column" alignItems="center" mx="0" mb={10} mt={2} justifyContent="space-between">
